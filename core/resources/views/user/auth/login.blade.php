...
@section('content')
    ...
    <div class="container padding-bottom-3x mb-1">
        <div class="row justify-content-center">
            <div class="col-md-5">
                <div style="padding: 35px;box-shadow: 0px 0px 14px 4px #cdcdcd;" class="card auth-form-card">
                    <form 
                        method="post" action="{{ route('user.login.submit') }}">
                        @csrf
                        <div class="card-body ">
                    ...
                    <div class="row">
                                <div class="col-lg-12 text-center mt-3">
                                    @if ($setting->facebook_check == 1)
                                        <a class="facebook-btn mr-2"
                                            href="{{ route('social.provider', 'facebook') }}">{{ __('Facebook login') }}
                                        </a>
                                    @endif
                                    @if ($setting->google_check == 1)
                                    <a href="{{ route('social.provider', 'google') }}">
                                        <button class="gsi-material-button"
                                            href="{{ route('social.provider', 'google') }}">
                                ...
                                <div class="text-center mt-4">
                                    <p class="text-muted">{{ __('Not registered ?') }}
                                        <a href="{{ route('user.register') }}"
                                            class="text-primary fw-bold">{{ __('Register now') }}</a>
                                    </p>
                                </div>
                            </div>
                </div>
